...
import { Clock, Calendar, Trash2, GripVertical, AlertCircle } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        {/* Drag handle */}
        {!task.isComplete && (
          <div className="absolute left-2 top-0 bottom-0 flex items-center cursor-grab opacity-50 hover:opacity-100">
